...
const Lecture = ({ fro, to, sub_code, sub_name }) => {
    return (
        <div className="max-container border-l-5 relative bg-[#F5F5F5] rounded-xl px-6 py-8 shadow-lg shadow-[#a0b8d9] font-[Plus Jakarta Sans] hover:shadow-[#a0b8d9]/20 height-auto  transition-shadow">
